...
/// <summary>
/// 送入 MAF 主会话前：结构化 Debug 日志 + 可选落盘（仅当设置环境变量 <c>OpenWorkmate_CONTEXT_SNAPSHOT_DIR</c>）。
...
public static class ContextTurnSnapshot
{
        ...
        ILogger logger)
    {
        ...
        var dir = Environment.GetEnvironmentVariable("OpenWorkmate_CONTEXT_SNAPSHOT_DIR");
