...
public interface IChatSessionStore
{
    ...
    Task SaveFromHistoryAsync(string sessionId, IReadOnlyList<ChatMessage> history, CancellationToken ct = default);
    ...
    /// <summary>按更新时间降序分页列出会话元数据。</summary>
    Task<(IReadOnlyList<ChatSessionListItemDto> Items, bool HasMore)> ListAsync(int skip, int take, CancellationToken ct = default);
